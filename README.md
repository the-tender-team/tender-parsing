...
## Разработчики
- **Бабицкий Иван** — тимлид, frontend-разработчик
- **Бурнаев Андрей** — backend-разработчик
- **Губеев Давид** — backend-разработчик
- **Николич Савва** — frontend-разработчик
...
2. **Интеграция с API для контента:**
   - получение данных с сайта zakupki.gov.ru;
