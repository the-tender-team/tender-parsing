const steps = [
  ...
  },
  {
    ...
    description: 'Пользователь может ознакомиться с полученными данными и предложить ответственным за тендеры лицам юридические услуги.',
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Сервис проводит анализ сайтов госзакупок, где компании участвуют в тендерах. 
            Если компания выиграла контракт, но не подписала его вовремя или нарушила условия, 
            ей может грозить суд. Сервис сохраняет информацию о таких тендерах и клиентах, 
            чтобы предлагать им свои юридические услуги.
          </p>
